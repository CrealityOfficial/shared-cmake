		...
		foreach(_component ${Components})
			if(NOT TARGET ${_component})
				...
				if(CC_BC_WIN)
					...
					set(${_component}_LIBRARIES_RELEASE "${RELEASE_ROOT}/lib/Release/${_component}.lib")
					set(${_component}_LOC_DEBUG "${DEBUG_ROOT}/bin/Debug/${_component}.dll")
					set(${_component}_LOC_RELEASE "${RELEASE_ROOT}/bin/Release/${_component}.dll")
				elseif(CC_BC_LINUX)
					if(${type} STREQUAL "dll")
						set(${_component}_LIBRARIES_DEBUG "${DEBUG_ROOT}/lib/lib${_component}.so")
						set(${_component}_LIBRARIES_RELEASE "${RELEASE_ROOT}/lib/lib${_component}.so")
