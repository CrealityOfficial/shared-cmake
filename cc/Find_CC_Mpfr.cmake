...
if(NOT TARGET mpfr)
	...
	elseif(CC_BC_LINUX)	
			set(mpfr_LIBRARIES_DEBUG "${MPFR_INSTALL_ROOT}/lib/Debug/libmpfr.a")
	    set(mpfr_LIBRARIES_RELEASE "${MPFR_INSTALL_ROOT}/lib/Release/libmpfr.a")
	    set(mpfr_LOC_DEBUG "${MPFR_INSTALL_ROOT}/bin/Debug/libmpfr.a")
	    set(mpfr_LOC_RELEASE "${MPFR_INSTALL_ROOT}/bin/Release/libmpfr.a")	
	endif()
