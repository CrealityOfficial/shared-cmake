...
function(__add_real_target target type)
	...
	if(target_SOURCE)
		...
		if(CC_BC_WIN AND ${type} STREQUAL "exe")
			set_target_properties(${target} PROPERTIES LINK_FLAGS_RELEASE "/SUBSYSTEM:WINDOWS /ENTRY:wmainCRTStartup")
			set_target_properties(${target} PROPERTIES LINK_FLAGS_DEBUG "/SUBSYSTEM:CONSOLE /ENTRY:wmainCRTStartup")
		endif()
